using mobosiSema.Common;
using mobosiSema.Data;
using System;
...
namespace mobosiSema
{
    ...
    public sealed partial class PivotPage : Page
    {
        ...
        {
            Frame.Navigate(typeof(addProgramPage));
        }
        ...
        {
            listBox.Items.Clear();
            foreach(var cur in DataSaver.DS.table)
            {
                listBox.Items.Add(cur);
            }   
        }
        ...
        {
            ProgrammatronProgram prog = e.AddedItems[0] as ProgrammatronProgram;
            Current.prog = prog;
            Frame.Navigate(typeof(programEditAndRun));
        }
    ...
    public static class Current
        {
            public static ProgrammatronProgram prog = null;
        }
}
